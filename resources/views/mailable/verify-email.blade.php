                    ...
                    <tr>
                        <td style="padding: 40px 30px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
                            ...
                            <p style="font-size: 16px; line-height: 1.6; color: #1f1f22; margin: 0 0 30px 0;">
                                Thank you for joining <strong>Tesher Harmony</strong>. We are thrilled to have you as part of our community of musicians and enthusiasts. To get full access to our instrument collection and marketplace, please verify your email address.
                            </p>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 30px;">
                                        ...
                                        <a href="{{ $url }}" target="_blank" style="background-color: #db2777; color: #ffffff; padding: 14px 28px; font-size: 16px; font-weight: bold; text-decoration: none; border-radius: 4px; display: inline-block; box-shadow: 0 2px 4px rgba(219, 39, 119, 0.3);">
                                            Verify My Account
                                        </a>
                                    </td>
                                </tr>
